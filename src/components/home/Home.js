...
const Home = (props) => {
    const { hasUser, clearUser, sessionUser, drugs, renderWidget, imageDesc, removeDrug, isChecked, drugImage, handleChange, getIdOfDrug, drug, handlePharmacyDropdown, pharmacyList, handleFieldChange, handleDrugForm, toggle, modal, toggleNested, toggleAll, nestedModal, closeAll } = props;
    ...
    return (
        <>
            ...
            <div>
                ...
                <MedicationFormModal imageDesc={imageDesc} renderWidget={renderWidget} drug={drug} handlePharmacyDropdown={handlePharmacyDropdown} pharmacyList={pharmacyList} drugImage={drugImage} handleFieldChange={handleFieldChange} handleDrugForm={handleDrugForm}
