...
const EditMedicationFormModal = ({ handlePharmacyDropdownEdit, pharmacyList, movingToHx, uploadImage, drug, handleEditFieldChange, isLoading, handleEditChange, toggleEdit, editModal, toggleNested, toggleAll, nestedModal, closeAll, props }) => {
            ...
            <FormText>*required</FormText>
                        ...
                        <ModalBody>
                            ...
                            <Input className="p-2 bd-highlight justify-content-center"
                                ...
                                onChange={handlePharmacyDropdownEdit}
                                type="select"
                                name="pharmacyId"
                                id="pharmacyId"
