...
const MedicationList = (props) => {
    const { setDrugs, drugs, removeDrug, handleChange, getIdOfDrug, drug, drugImage, handlePharmacyDropdown, pharmacyList, uploadImage, handleFieldChange, handleDrugForm, toggle, modal, toggleNested, toggleAll, nestedModal, closeAll } = props
    ...
    return (
        <>
            ...
            <SearchBar className="searchBar-medicationList" {...props} drug={drug} getIdOfDrug={getIdOfDrug} handleChange={handleChange} isChecked={isChecked} setIsChecked={setIsChecked}
            />
